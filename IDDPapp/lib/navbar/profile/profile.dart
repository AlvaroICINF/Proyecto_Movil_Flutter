          ...
          children: [
            ...
            SizedBox(width: 250,
              child: Padding(padding: EdgeInsets.all(25),
                ...
                child: Text('Ingresar',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white),
                ),),),
            ),
              ...
              SizedBox(width: 252,
                child: Padding(padding: EdgeInsets.all(25),
                child: ElevatedButton(onPressed: (){
                  //llamamos a nuestra ruta de register
                ...
                child: Text('Registrarme',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white),
                ),),),
              )
          ],
        ),),
